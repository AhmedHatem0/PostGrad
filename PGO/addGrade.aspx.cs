...
namespace postgrad_office
{
    public partial class addGrade : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            String gra = grade.Text;
            SqlCommand addcom = new SqlCommand("AddDefenseGrade", con);
            addcom.CommandType = CommandType.StoredProcedure;

            if (ser.Length * dat.Length * gra.Length != 0)
            {
                ...
                addcom.Parameters.Add(new SqlParameter("@grade", SqlDbType.Int)).Value = gra;
